...
class VisitRecordRepository {
  ...
  Future<Map<String, dynamic>> getOne(int visitRecordId) async {
    ...
    //   }
    // };
    Logger().d('VisitRecordRepository getOne:  $responseBody');
    return responseBody;
  }
  ...
  Future<Map<String, dynamic>> getDayGameList(String date) async {
    Response response =
        await dio.get('/s/api/visit-records', queryParameters: {'data': date});
    final responseBody = response.data;
    // final responseBody = {
    //   "status": 200,
    //   "msg": "성공",
    ...
    //   ]
    // };
    Logger().d('VisitRecordRepository getDayGameList:  $responseBody');
    return responseBody;
  }
  ...
  Future<Map<String, dynamic>> getMonthGameList(
    ...
    //   ]
    // };
    Logger().d('VisitRecordRepository getMonthGameList:  $responseBody');
    return responseBody;
  }
  ...
  Future<Map<String, dynamic>> getGameList(String date) async {
    ...
    //   }
    // };
    Logger().d('VisitRecordRepository getGameList:  $responseBody');
    return responseBody;
  }
  ...
  Future<Map<String, dynamic>> getHasGameDay(String date) async {
    Response response =
        await dio.get("/s/api/games/dates", queryParameters: {"date": date});
    final responseBody = response.data;
    // final responseBody = {
    //   "status": 200,
    //   "msg": "성공",
    ...
    //   ]
    // };
    Logger().d('VisitRecordRepository getHasGameDay:  $responseBody');
    return responseBody;
  }
}
