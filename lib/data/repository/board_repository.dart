...
class BoardRepository {
  ...
  Future<Map<String, dynamic>> getList() async {
    ...
    //         "teamId": 1,
    //         "teamName": "LG 트윈스",
    //         "teamLogo": "https://cdn.pixabay.com/photo/2023/02/04/14/18/underwater-7767303_640.jpg",
    //         "teamRank": 1
    //       },
    //       {
    //         "teamId": 2,
  ...
  Future<Map<String, dynamic>> write(int teamId, String title, String content, List<String> images) async {
    try {
      final Map<String, dynamic> requestBody = {
        "title": title,
        "teamId": teamId,
        "content": content,
        "images": images, // <-- 백엔드의 SaveDTO 필드 이름 'images'와 일치시킴
      };

      Response response = await dio.post("/s/api/boards", data: requestBody);
      final responseBody = response.data;
      ...
      Logger().e('Error in BoardRepository write: $e');
      rethrow; // 에러를 다시 던져서 상위 로직에서 처리할 수 있도록 합니다.
    }
  }
