...
class GameCenterRepository {
  ...
  // 유저 승리 예측 진입
  Future<Map<String, dynamic>> getBeforePredictionList() async {
    ...
    //         "teamName": "LG 트윈스",
    //         "logoUrl":
    //             "https://upload.wikimedia.org/wikipedia/ko/4/4f/LG_Twins.png"
    //       },
    //       "homeVoteRate": 50,
    //       "awayVoteRate": 50
    //     },
    ...
    //   ]
    // };
    Logger().d("GameCenterRepository getBeforePredictionList : $responseBody");
    return responseBody;
  }
  ...
  // 유저 승리 예측 결과
  Future<Map<String, dynamic>> getAfterPredictionList() async {
    Response response = await dio.get("/s/api/today-games/prediction",
        queryParameters: {"date": formatDateToStr(today)});
    ...
    //   ]
    // };
    Logger().d("GameCenterRepository getAfterPredictionList : $responseBody");
    return responseBody;
  }
}
