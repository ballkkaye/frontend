...
class UserMatchRepository {
  Future<Map<String, dynamic>> getOne(int userMatchId) async {
    ...
    //   }
    // };
    Logger().d('UserMatchRepository getOne:  $responseBody');
    return responseBody;
  }
  ...
  Future<Map<String, dynamic>> getList({
    ...
    //   }
    // };
    Logger().d('UserMatchRepository getList:  $responseBody');
    return responseBody;
  }
  ...
  Future<Map<String, dynamic>> getListByQuery({
    ...
    //   }
    // };
    Logger().d('UserMatchRepository getListByQuery:  $responseBody');
    return responseBody;
  }
  ...
  Future<Map<String, dynamic>> write(Map<String, dynamic> data) async {
    ...
    //   }
    // };
    Logger().d('UserMatchRepository write:  $responseBody');
    return responseBody;
  }
}
