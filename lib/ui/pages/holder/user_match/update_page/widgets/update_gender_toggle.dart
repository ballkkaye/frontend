...
class UpdateGenderToggle extends StatefulWidget {
  const UpdateGenderToggle({super.key});

  @override
  State<UpdateGenderToggle> createState() => _UpdateGenderToggleState();
}

class _UpdateGenderToggleState extends State<UpdateGenderToggle> {
          ...
          return Expanded(
            child: GestureDetector(
              ...
              child: Container(
                  ...
                  child: MText.button3(genderOptions[index],
                      color: selected
                          ? MColor.kPrimary.strong
