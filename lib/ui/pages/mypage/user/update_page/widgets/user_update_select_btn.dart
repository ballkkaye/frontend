...
class UserUpdateSelectBtn extends StatefulWidget {
  final List<String> options;
  final String hintText;
  final void Function(String?)? onChanged;

  const UserUpdateSelectBtn({
    super.key,
  ...
  @override
  State<UserUpdateSelectBtn> createState() => _UserUpdateSelectBtnState();
}

class _UserUpdateSelectBtnState extends State<UserUpdateSelectBtn> {
    ...
    return DropdownButtonHideUnderline(
      child: DropdownButton2<String>(
        ...
        hint: Text(
          widget.hintText,
          style: TextStyle(
              color: isActive ? Colors.black : MColor.kLabel.alternative, fontSize: 16, fontWeight: FontWeight.w400),
        ),
        value: selectedValue,
        onChanged: (value) {
          setState(() {
