...
class MText {
  ...
  static Text labelHint(String text, {Color? color}) => Text(
        text,
        style: TextStyle(
            fontSize: 14,
  ...
  static Text labelTiny(String text, {Color? color}) => Text(
        text,
        style:
  ...
  static Text modalTiny(String text, {Color? color}) => Text(
        text,
        style:
            TextStyle(fontSize: 10, fontWeight: FontWeight.w400, color: color),
      );
  ...
  // 점수/특수
  static Text scoreHuge(String text, {Color? color}) => Text(
        text,
        style:
            TextStyle(fontSize: 64, fontWeight: FontWeight.w700, color: color),
      );
